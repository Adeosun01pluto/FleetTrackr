    ...
    <>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {isAdmin ? (
            <>
              <Link to="/dashboard/orders" className="bg-[#e63946] text-white py-2 px-4 rounded-md hover:bg-[#e63946]/90 transition-colors">
                Add New Order
              </Link>
              <Link to="/dashboard/price-list" className="bg-[#e63946] text-white py-2 px-4 rounded-md hover:bg-[#e63946]/90 transition-colors">
                Update Price List
              </Link>
              <Link to="/dashboard/blog-manager" className="bg-[#e63946] text-white py-2 px-4 rounded-md hover:bg-[#e63946]/90 transition-colors">
                Create Blog Post
              </Link>
              <Link to="/dashboard/orders" className="bg-[#e63946] text-white py-2 px-4 rounded-md hover:bg-[#e63946]/90 transition-colors">
                Send Notification
            ...
            <>
              ...
              <Link to="/dashboard/edit-profile" className="bg-[#e63946] text-white py-2 px-4 rounded-md hover:bg-[#e63946]/90 transition-colors">
                Edit Profile
              </Link>
            </>
          )}
