      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <p className="text-lg text-gray-700 mb-6">
            At [Your Company Name], we've been at the forefront of vehicle management for over two decades. Our journey began with a simple mission: to revolutionize how businesses and individuals manage their vehicles.
          </p>
          <p className="text-lg text-gray-700 mb-6">
