...
const Signup = () => {
  ...
  const signUpWithEmail = async (e) => {
    ...
    console.log("first line triggered")
    try {
      const userCredential = await createUserWithEmailAndPassword(auth, email, password);
      const user = userCredential.user;
      console.log("second line triggered")
      ...
      console.log("third line triggered")
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-0 sm:mt-6 text-center text-xl sm:text-3xl font-extrabold text-gray-900">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={signUpWithEmail}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-[#e63946] hover:text-[#e63946]/80">
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#e63946] hover:bg-[#e63946]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#e63946]"
              >
                Sign up
              </button>
            </div>
          ...
          <div className='flex items-center w-full justify-center gap-2 pt-3'>
            <p>Already have an account? </p> <Link to="/login" className='font-semibold text-[#e63946]'>Login</Link>
          </div>
